...
## _fix_undefined_branch_conditions — REMOVED (no-op: never fires)


## _fix_misplaced_continue_targets — REMOVED (no-op: never fires)

## _fix_null_struct_loads — REMOVED (no-op: never fires)
...
## _fix_type_context_infinite_loops — REMOVED (no-op: never fires)
