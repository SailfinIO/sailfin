...
- `graduate <N>`: only after Stage1 readiness is met end-to-end and self-hosts, set `Implemented`, wire `graduates-to`, update the relevant spec/preview page, and sync the registry. Leave docs/status.md to the release-cadence sweep.
