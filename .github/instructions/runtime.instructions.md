...
- The Runtime Migration table in `docs/status.md` tracks C→Sailfin progress; read it, but leave the row to the release-cadence sweep rather than editing it in a migration PR.
