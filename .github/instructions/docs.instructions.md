...
- `docs/spec.md` is the language reference: Part A covers shipped features, Part B covers planned.
- `docs/roadmap.md` tracks active workstreams and sequencing.
- `docs/proposals/` holds future-facing designs — leave them there until `status.md` marks them shipped.
- Align terminology with `docs/spec.md` (capsule, fleet, provenance card, generation card).
