...
then22:
  ...
  %t844 = bitcast [32 x i8]* %t843 to i8*
  ...
  %t855 = bitcast [32 x i8]* %t854 to i8*
...
then32:
  ...
  %t1235 = getelementptr inbounds i8, i8* %t1234, i64 24
  ...
  %t1248 = bitcast [24 x i8]* %t1247 to i8*
  ...
  %t1255 = bitcast [16 x i8]* %t1254 to i8*
...
then36:
  ...
  %t1496 = bitcast [40 x i8]* %t1495 to i8*
  %t1497 = getelementptr inbounds i8, i8* %t1496, i64 24
  ...
  %t1510 = bitcast [24 x i8]* %t1509 to i8*
  ...
  %t1517 = bitcast [16 x i8]* %t1516 to i8*
...
then38:
  ...
  %t1627 = bitcast [40 x i8]* %t1626 to i8*
  %t1628 = getelementptr inbounds i8, i8* %t1627, i64 24
  ...
  %t1642 = getelementptr inbounds i8, i8* %t1641, i64 8
  ...
  %t1648 = bitcast [16 x i8]* %t1647 to i8*
...
then8:
  ...
  %t66 = call noalias i8* @malloc(i64 32)
...
then8:
  ...
  %t70 = call noalias i8* @malloc(i64 32)
