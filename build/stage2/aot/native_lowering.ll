...
merge1:
  ...
  %t50 = call i8* @builder_to_string__native_lowering(%PythonBuilder %t49)
  store i8* %t50, i8** %l4
  %t51 = load i8*, i8** %l4
...
then0:
  ...
  %t38 = call %PythonBuilder @builder_emit_blank__native_lowering(%PythonBuilder %t37)
...
merge1:
  ...
  %t52 = call %PythonBuilder @builder_emit_blank__native_lowering(%PythonBuilder %t51)
...
then2:
  ...
  %t62 = call %PythonBuilder @builder_emit_blank__native_lowering(%PythonBuilder %t61)
...
then4:
  ...
  %t76 = call %PythonBuilder @builder_emit_blank__native_lowering(%PythonBuilder %t75)
...
then6:
  ...
  %t90 = call %PythonBuilder @builder_emit_blank__native_lowering(%PythonBuilder %t89)
...
merge7:
  ...
  %t106 = call %PythonBuilder @builder_emit_blank__native_lowering(%PythonBuilder %t105)
...
then14:
  ...
  %t151 = call %PythonBuilder @builder_emit_blank__native_lowering(%PythonBuilder %t150)
...
then16:
  ...
  %t175 = call %PythonBuilder @builder_emit_blank__native_lowering(%PythonBuilder %t174)
...
then6:
  ...
  %t35 = load i8*, i8** %l4
  %t36 = load i8*, i8** %l5
  %t37 = call i8* @lower_expression__native_lowering(i8* %t36)
...
then6:
  ...
  %t47 = call i8* @trim_text__native_lowering(i8* %t46)
  store i8* %t47, i8** %l4
  %t48 = load i8*, i8** %l4
...
afterloop5:
  ...
  %t58 = call i8* @join_with_separator__native_lowering({ i8**, i64 }* %t56, i8* %s57)
...
afterloop3:
  ...
  %t45 = call i8* @join_with_separator__native_lowering({ i8**, i64 }* %t43, i8* %s44)
...
merge1:
  ...
  %t8 = call i1 @starts_with__native_lowering(i8* %t6, i8* %s7)
  %t9 = load i8*, i8** %l0
...
merge3:
  ...
  %t23 = call i1 @starts_with__native_lowering(i8* %t21, i8* %s22)
  %t24 = load i8*, i8** %l0
...
afterloop19:
  ...
  %t153 = call i8* @join_with_separator__native_lowering({ i8**, i64 }* %t151, i8* %s152)
...
block.entry:
  ...
  %t11 = call %PythonBuilder @builder_push_indent__native_lowering(%PythonBuilder %t10)
...
then0:
  ...
  %t41 = call i8* @join_with_separator__native_lowering({ i8**, i64 }* %t39, i8* %s40)
...
merge1:
  ...
  %t58 = call %PythonBuilder @builder_push_indent__native_lowering(%PythonBuilder %t57)
...
merge4:
  ...
  %t125 = call %PythonBuilder @builder_pop_indent__native_lowering(%PythonBuilder %t124)
  store %PythonBuilder %t125, %PythonBuilder* %l1
  %t126 = load %PythonBuilder, %PythonBuilder* %l1
  %t127 = call %PythonBuilder @builder_emit_blank__native_lowering(%PythonBuilder %t126)
  ...
  %t132 = call %PythonBuilder @builder_push_indent__native_lowering(%PythonBuilder %t131)
  ...
  %t140 = call %PythonBuilder @builder_pop_indent__native_lowering(%PythonBuilder %t139)
...
then11:
  ...
  %t156 = call %PythonBuilder @builder_push_indent__native_lowering(%PythonBuilder %t155)
  ...
  %t164 = call %PythonBuilder @builder_push_indent__native_lowering(%PythonBuilder %t163)
  ...
  %t169 = call %PythonBuilder @builder_push_indent__native_lowering(%PythonBuilder %t168)
  ...
  %t174 = call %PythonBuilder @builder_pop_indent__native_lowering(%PythonBuilder %t173)
  ...
  %t187 = call %PythonBuilder @builder_pop_indent__native_lowering(%PythonBuilder %t186)
  ...
  %t192 = call %PythonBuilder @builder_pop_indent__native_lowering(%PythonBuilder %t191)
  ...
  %t197 = call %PythonBuilder @builder_pop_indent__native_lowering(%PythonBuilder %t196)
...
then13:
  ...
  %t247 = call %PythonBuilder @builder_emit_blank__native_lowering(%PythonBuilder %t246)
...
then21:
  ...
  %t306 = call %PythonBuilder @builder_emit_blank__native_lowering(%PythonBuilder %t305)
...
merge14:
  ...
  %t328 = call %PythonBuilder @builder_pop_indent__native_lowering(%PythonBuilder %t327)
...
afterloop5:
  ...
  %t69 = call i8* @join_with_separator__native_lowering({ i8**, i64 }* %t67, i8* %s68)
...
merge3:
  ...
  %t8 = call double @find_substring__native_lowering(i8* %t6, i8* %s7)
...
merge5:
  ...
  %t14 = call double @find_substring__native_lowering(i8* %t12, i8* %s13)
...
merge13:
  ...
  %t58 = call double @find_substring_from__native_lowering(i8* %t54, i8* %s55, double %t57)
...
merge15:
  ...
  %t89 = call double @find_substring_from__native_lowering(i8* %t84, i8* %s85, double %t88)
...
merge17:
  ...
  %t110 = call i8* @trim_text__native_lowering(i8* %t109)
  store i8* %t110, i8** %l8
  %t111 = load i8*, i8** %l8
...
afterloop31:
  ...
  %t264 = call i8* @join_with_separator__native_lowering({ i8**, i64 }* %t262, i8* %s263)
  %t265 = add i64 0, 2
  ...
  %t275 = call i8* @join_with_separator__native_lowering({ i8**, i64 }* %t273, i8* %s274)
  %t276 = add i64 0, 2
...
then28:
  ...
  %t297 = call i8* @join_with_separator__native_lowering({ i8**, i64 }* %t295, i8* %s296)
  %t298 = add i64 0, 2
...
merge29:
  ...
  %t328 = call i8* @join_with_separator__native_lowering({ i8**, i64 }* %t326, i8* %s327)
...
merge15:
  ...
  %t113 = call i8* @join_with_separator__native_lowering({ i8**, i64 }* %t111, i8* %s112)
  store i8* %t113, i8** %l7
  %t114 = load i8*, i8** %l7
  %t115 = add i64 0, 2
...
merge1:
  ...
  %t7 = call i1 @starts_with__native_lowering(i8* %t5, i8* %s6)
  %t8 = xor i1 %t7, 1
  %t9 = load i8*, i8** %l0
  br i1 %t8, label %then2, label %merge3
then2:
...
merge3:
  ...
  %t14 = call i8* @trim_text__native_lowering(i8* %t13)
  store i8* %t14, i8** %l1
  %t15 = load i8*, i8** %l1
...
merge11:
  ...
  %t126 = call i8* @trim_text__native_lowering(i8* %t125)
  store i8* %t126, i8** %l6
  %t127 = load i8*, i8** %l6
...
merge19:
  %t204 = load i8*, i8** %l1
  %t205 = call i8* @trim_text__native_lowering(i8* %t204)
  %t206 = call i8* @trim_trailing_delimiters__native_lowering(i8* %t205)
  store i8* %t206, i8** %l7
  %t207 = load i8*, i8** %l7
  %t208 = add i64 0, 2
  ...
  %t211 = call i1 @ends_with__native_lowering(i8* %t207, i8* %t209)
  %t212 = xor i1 %t211, 1
  %t213 = load i8*, i8** %l0
  %t214 = load i8*, i8** %l1
...
then8:
  ...
  %t33 = call double @skip_string_literal__native_lowering(i8* %expression, double %t32)
...
then8:
  %t40 = load double, double* %l3
  %t41 = call double @skip_string_literal__native_lowering(i8* %expression, double %t40)
...
loop.body1:
  ...
  %t3 = call double @index_of__native_lowering(i8* %t1, i8* %s2)
  store double %t3, double* %l1
  %t4 = load double, double* %l1
  %t5 = sitofp i64 0 to double
  %t6 = fcmp olt double %t4, %t5
...
merge9:
  ...
  %t51 = call i8* @trim_text__native_lowering(i8* %t50)
  store i8* %t51, i8** %l8
  %t52 = load i8*, i8** %l7
  %t53 = add i64 0, 2
...
merge7:
  ...
  %t35 = call i8* @trim_text__native_lowering(i8* %t34)
  store i8* %t35, i8** %l5
  %t36 = load i8*, i8** %l5
...
then18:
  ...
  %t98 = call double @skip_string_literal__native_lowering(i8* %text, double %t97)
...
merge1:
  ...
  %t3 = call i1 @starts_with__native_lowering(i8* %segment, i8* %s2)
  br i1 %t3, label %then2, label %merge3
then2:
  ret i1 1
merge3:
  %s4 = getelementptr inbounds [3 x i8], [3 x i8]* @.str.len2.h193516127, i32 0, i32 0
  %t5 = call i1 @starts_with__native_lowering(i8* %segment, i8* %s4)
...
block.entry:
  ...
  %t24 = call i8* @join_with_separator__native_lowering({ i8**, i64 }* %t22, i8* %s23)
  ...
  %t32 = call %PythonBuilder @builder_push_indent__native_lowering(%PythonBuilder %t31)
  store %PythonBuilder %t32, %PythonBuilder* %l0
...
then2:
  ...
  %t61 = load %PythonBuilder, %PythonBuilder* %l0
  %t62 = call %PythonBuilder @builder_pop_indent__native_lowering(%PythonBuilder %t61)
  store %PythonBuilder %t62, %PythonBuilder* %l0
  %t63 = load %PythonBuilder, %PythonBuilder* %l0
...
merge18:
  ...
  %t298 = load i8*, i8** %l9
  %t299 = call i8* @lower_expression__native_lowering(i8* %t298)
...
merge26:
  ...
  %t459 = load i8*, i8** %l13
  %t460 = call i8* @lower_expression__native_lowering(i8* %t459)
...
merge37:
  ...
  %t641 = load i8*, i8** %l18
  %t642 = load i8*, i8** %l19
  %t643 = call i8* @lower_expression__native_lowering(i8* %t642)
...
then40:
  ...
  %t735 = call i8* @trim_text__native_lowering(i8* %t734)
  ...
  %t747 = call %PythonBuilder @builder_push_indent__native_lowering(%PythonBuilder %t746)
...
then46:
  ...
  %t832 = call %PythonBuilder @builder_pop_indent__native_lowering(%PythonBuilder %t831)
...
merge48:
  ...
  %t845 = call %PythonBuilder @builder_push_indent__native_lowering(%PythonBuilder %t844)
...
then52:
  ...
  %t928 = call %PythonBuilder @builder_pop_indent__native_lowering(%PythonBuilder %t927)
...
then55:
  ...
  %t1020 = call i8* @trim_text__native_lowering(i8* %t1019)
  ...
  %t1044 = call %PythonBuilder @builder_push_indent__native_lowering(%PythonBuilder %t1043)
...
then61:
  ...
  %t1129 = call %PythonBuilder @builder_pop_indent__native_lowering(%PythonBuilder %t1128)
...
then64:
  ...
  %t1215 = call %PythonBuilder @builder_push_indent__native_lowering(%PythonBuilder %t1214)
...
then70:
  ...
  %t1300 = call %PythonBuilder @builder_pop_indent__native_lowering(%PythonBuilder %t1299)
...
then79:
  ...
  %t1546 = call i8* @lower_expression__native_lowering(i8* %t1545)
...
then85:
  ...
  %t1652 = call i8* @trim_text__native_lowering(i8* %t1651)
...
then90:
  ...
  %t1714 = call %PythonBuilder @builder_pop_indent__native_lowering(%PythonBuilder %t1713)
...
merge91:
  ...
  %t1738 = call %LoweredCaseCondition @lower_match_case_condition__native_lowering(i8* %t1718, i8* %t1727, i8* %t1737)
...
merge94:
  ...
  %t1805 = call %PythonBuilder @builder_push_indent__native_lowering(%PythonBuilder %t1804)
...
then104:
  ...
  %t1950 = call %PythonBuilder @builder_pop_indent__native_lowering(%PythonBuilder %t1949)
...
else107:
  ...
  %t2044 = call i8* @trim_text__native_lowering(i8* %t2043)
...
then117:
  ...
  %t2623 = call %PythonBuilder @builder_pop_indent__native_lowering(%PythonBuilder %t2622)
...
merge124:
  ...
  %t2663 = call %PythonBuilder @builder_pop_indent__native_lowering(%PythonBuilder %t2662)
...
afterloop122:
  ...
  %t2681 = call %PythonBuilder @builder_pop_indent__native_lowering(%PythonBuilder %t2680)
...
block.entry:
  ...
  %t1 = call i8* @number_to_string__native_lowering(double %counter)
...
merge7:
  %t34 = load i8*, i8** %l1
  %t35 = call i8* @lower_expression__native_lowering(i8* %t34)
  store i8* %t35, i8** %l3
  %t36 = load i8*, i8** %l3
...
merge5:
  %t40 = load i8*, i8** %l0
  %t41 = call i8* @lower_expression__native_lowering(i8* %t40)
  store i8* %t41, i8** %l4
...
then8:
  %t53 = load i8*, i8** %l1
  %t54 = call i8* @lower_expression__native_lowering(i8* %t53)
  store i8* %t54, i8** %l7
  %t55 = load i8*, i8** %l5
  %t56 = add i64 0, 2
  %t57 = call i8* @malloc(i64 %t56)
...
merge16:
  ...
  %t114 = call i8* @join_with_separator__native_lowering({ i8**, i64 }* %t110, i8* %t112)
...
define i1 @is_whitespace_char__native_lowering(i8* %ch) {
block.entry:
  %t0 = load i8, i8* %ch
  %t1 = icmp eq i8 %t0, 32
  br i1 %t1, label %then0, label %merge1
