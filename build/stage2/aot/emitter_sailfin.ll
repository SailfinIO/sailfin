...
block.entry:
  ...
  %s7 = getelementptr inbounds [35 x i8], [35 x i8]* @.str.len34.h160552901, i32 0, i32 0
  %t8 = call %TextBuilder @builder_emit_line__emitter_sailfin(%TextBuilder %t6, i8* %s7)
  store %TextBuilder %t8, %TextBuilder* %l0
  %t9 = load %TextBuilder, %TextBuilder* %l0
  %t10 = call %TextBuilder @builder_emit_blank__emitter_sailfin(%TextBuilder %t9)
...
merge5:
  ...
  %t33 = call %TextBuilder @emit_statement__emitter_sailfin(%TextBuilder %t22, %Statement %t32)
...
then6:
  ...
  %t45 = call %TextBuilder @builder_emit_blank__emitter_sailfin(%TextBuilder %t44)
...
afterloop3:
  ...
  %t58 = call i8* @builder_to_string__emitter_sailfin(%TextBuilder %t57)
...
block.entry:
  ...
  store i8* %t8, i8** %l1
  %t9 = load i8*, i8** %l1
  %t10 = call %TextBuilder @builder_emit_line__emitter_sailfin(%TextBuilder %builder, i8* %t9)
  ret %TextBuilder %t10
}
