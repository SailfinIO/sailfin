...
then10:
  ...
  %t155 = call %TextBuilder @builder_emit_line__emitter_sailfin(%TextBuilder %t152, i8* %t153)
...
logical_and_merge_194:
  ...
  %t207 = call %TextBuilder @emit_statement__emitter_sailfin(%TextBuilder %t205, %Statement %t206)
...
afterloop15:
  ...
  %t222 = call i8* @builder_to_string__emitter_sailfin(%TextBuilder %t221)
...
then4:
  %t272 = call %TextBuilder @emit_variable__emitter_sailfin(%TextBuilder %builder, %Statement %statement)
...
then6:
  ...
  %t531 = call %TextBuilder @emit_function__emitter_sailfin(%TextBuilder %builder, %FunctionSignature %t366, %Block %t423, { %Decorator*, i64 }* %t530)
...
then8:
  %t606 = call %TextBuilder @emit_struct__emitter_sailfin(%TextBuilder %builder, %Statement %statement)
...
then14:
  %t1203 = call %TextBuilder @emit_test__emitter_sailfin(%TextBuilder %builder, %Statement %statement)
...
then16:
  %t1278 = call %TextBuilder @emit_model__emitter_sailfin(%TextBuilder %builder, %Statement %statement)
...
then18:
  %t1353 = call %TextBuilder @emit_type_alias__emitter_sailfin(%TextBuilder %builder, %Statement %statement)
...
then20:
  %t1428 = call %TextBuilder @emit_interface__emitter_sailfin(%TextBuilder %builder, %Statement %statement)
...
then22:
  %t1503 = call %TextBuilder @emit_enum__emitter_sailfin(%TextBuilder %builder, %Statement %statement)
...
then24:
  ...
  %t1591 = load i8*, i8** %l0
  %t1592 = call %TextBuilder @builder_emit_line__emitter_sailfin(%TextBuilder %builder, i8* %t1591)
...
merge25:
  ...
  %t1667 = call %TextBuilder @builder_emit_line__emitter_sailfin(%TextBuilder %builder, i8* %t1666)
...
then0:
  ...
  %t82 = call i8* @format_optional_expression__emitter_sailfin(%Expression* %t81)
  store i8* %t82, i8** %l0
  %t83 = load i8*, i8** %l0
...
then2:
  ...
  %t89 = call %TextBuilder @builder_emit_line__emitter_sailfin(%TextBuilder %builder, i8* %t87)
  ret %TextBuilder %t89
merge3:
  ...
  %t98 = call %TextBuilder @builder_emit_line__emitter_sailfin(%TextBuilder %builder, i8* %t97)
  ret %TextBuilder %t98
merge1:
  %t99 = extractvalue %Statement %statement, 0
  %t100 = getelementptr inbounds [1 x i8], [1 x i8]* @.enum.Statement.variant.default, i32 0, i32 0
...
then4:
  ...
  %t280 = call %TextBuilder @emit_decorators__emitter_sailfin(%TextBuilder %builder, { %Decorator*, i64 }* %t279)
...
then6:
  ...
  %t418 = call %TextBuilder @builder_emit_line__emitter_sailfin(%TextBuilder %builder, i8* %t416)
...
then8:
  ...
  %t495 = call %TextBuilder @builder_emit_line__emitter_sailfin(%TextBuilder %builder, i8* %t493)
...
then10:
  ...
  %t584 = call i8* @format_expression__emitter_sailfin(%Expression %t583)
  %t585 = add i64 0, 2
  ...
  %t589 = call %TextBuilder @builder_emit_line__emitter_sailfin(%TextBuilder %builder, i8* %t588)
...
then12:
  %t664 = call %TextBuilder @emit_variable__emitter_sailfin(%TextBuilder %builder, %Statement %statement)
...
then14:
  %t739 = call %TextBuilder @emit_prompt__emitter_sailfin(%TextBuilder %builder, %Statement %statement)
...
then16:
  %t814 = call %TextBuilder @emit_with__emitter_sailfin(%TextBuilder %builder, %Statement %statement)
...
then18:
  %t889 = call %TextBuilder @emit_if__emitter_sailfin(%TextBuilder %builder, %Statement %statement)
...
then20:
  %t964 = call %TextBuilder @emit_for__emitter_sailfin(%TextBuilder %builder, %Statement %statement)
...
then22:
  %t1039 = call %TextBuilder @emit_test__emitter_sailfin(%TextBuilder %builder, %Statement %statement)
...
then24:
  ...
  %t1127 = load i8*, i8** %l2
  %t1128 = call %TextBuilder @builder_emit_line__emitter_sailfin(%TextBuilder %builder, i8* %t1127)
  ret %TextBuilder %t1128
merge25:
  %t1129 = extractvalue %Statement %statement, 0
  %t1130 = getelementptr inbounds [1 x i8], [1 x i8]* @.enum.Statement.variant.default, i32 0, i32 0
...
then26:
  ...
  %t1387 = call %TextBuilder @emit_function__emitter_sailfin(%TextBuilder %builder, %FunctionSignature %t1222, %Block %t1279, { %Decorator*, i64 }* %t1386)
...
then28:
  %t1462 = call %TextBuilder @emit_match__emitter_sailfin(%TextBuilder %builder, %Statement %statement)
...
merge29:
  ...
  %t1537 = call %TextBuilder @builder_emit_line__emitter_sailfin(%TextBuilder %builder, i8* %t1536)
...
block.entry:
  ...
  %t183 = call %TextBuilder @builder_emit_line__emitter_sailfin(%TextBuilder %t179, i8* %t181)
...
then4:
  ...
  %t98 = call i8* @format_expression__emitter_sailfin(%Expression %t97)
...
merge7:
  ...
  %t131 = call %TextBuilder @emit_else_branch__emitter_sailfin(%TextBuilder %t128, %ElseBranch %t130)
  ret %TextBuilder %t131
merge5:
  %t132 = call i8* @malloc(i64 5)
  %t133 = bitcast i8* %t132 to [5 x i8]*
  store [5 x i8] c"else\00", [5 x i8]* %t133
  %t134 = call %TextBuilder @builder_emit_line__emitter_sailfin(%TextBuilder %builder, i8* %t132)
...
then4:
  ...
  %t185 = call i8* @format_expression__emitter_sailfin(%Expression %t184)
  %t186 = add i64 0, 2
