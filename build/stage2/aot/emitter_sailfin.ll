...
then2:
  ...
  %t93 = call %TextBuilder @builder_emit_line__emitter_sailfin(%TextBuilder %builder, i8* %s92)
  ret %TextBuilder %t93
merge3:
  ...
  %t109 = call i8* @format_expression__emitter_sailfin(%Expression %t108)
  ...
  %t115 = call %TextBuilder @builder_emit_line__emitter_sailfin(%TextBuilder %builder, i8* %t114)
...
then4:
  ...
  %t203 = call i8* @format_expression__emitter_sailfin(%Expression %t202)
  %t204 = add i64 0, 2
  ...
  %t208 = call %TextBuilder @builder_emit_line__emitter_sailfin(%TextBuilder %builder, i8* %t207)
...
then6:
  %t282 = call %TextBuilder @emit_variable__emitter_sailfin(%TextBuilder %builder, %Statement %statement)
...
then8:
  %t356 = call %TextBuilder @emit_prompt__emitter_sailfin(%TextBuilder %builder, %Statement %statement)
...
then10:
  %t430 = call %TextBuilder @emit_with__emitter_sailfin(%TextBuilder %builder, %Statement %statement)
...
then12:
  %t504 = call %TextBuilder @emit_if__emitter_sailfin(%TextBuilder %builder, %Statement %statement)
...
then14:
  %t578 = call %TextBuilder @emit_for__emitter_sailfin(%TextBuilder %builder, %Statement %statement)
...
then16:
  %t652 = call %TextBuilder @emit_test__emitter_sailfin(%TextBuilder %builder, %Statement %statement)
...
then18:
  ...
  store i8* %t737, i8** %l0
  %t738 = load i8*, i8** %l0
  %t739 = call %TextBuilder @builder_emit_line__emitter_sailfin(%TextBuilder %builder, i8* %t738)
...
then20:
  ...
  %t997 = call %TextBuilder @emit_function__emitter_sailfin(%TextBuilder %builder, %FunctionSignature %t832, %Block %t889, { %Decorator*, i64 }* %t996)
...
then22:
  %t1071 = call %TextBuilder @emit_match__emitter_sailfin(%TextBuilder %builder, %Statement %statement)
...
merge23:
  ...
  %t1145 = call %TextBuilder @builder_emit_line__emitter_sailfin(%TextBuilder %builder, i8* %t1144)
...
merge3:
  ...
  %t108 = call i8* @format_expression__emitter_sailfin(%Expression %t107)
...
then4:
  ...
  %t201 = call i8* @format_expression__emitter_sailfin(%Expression %t200)
  %t202 = add i64 0, 2
...
merge5:
  ...
  %t21 = call i8* @escape_string_char__emitter_sailfin(i8* %t19)
...
then2:
  ...
  %t25 = call i8* @trim_text__emitter_sailfin(i8* %t24)
...
afterloop3:
  ...
  %t77 = load i8*, i8** %l0
  %t78 = call i8* @trim_text__emitter_sailfin(i8* %t77)
...
merge5:
  ...
  store i8 0, i8* %t18
  call void @sailfin_runtime_mark_persistent(i8* %t17)
  %t19 = call i1 @is_trim_char__emitter_sailfin(i8* %t17)
  %t20 = load double, double* %l0
  %t21 = load double, double* %l1
  %t22 = load i8, i8* %l2
  br i1 %t19, label %then6, label %merge7
...
merge13:
  ...
  %t47 = call i1 @is_trim_char__emitter_sailfin(i8* %t45)
