...
merge7:
  ...
  %t17 = call i8* @char_at__string_utils(i8* %name, double %t16)
  store i8* %t17, i8** %l2
  %t18 = load i8*, i8** %l2
  %t19 = call i1 @is_symbol_char__string_utils(i8* %t18)
  %t20 = load i8*, i8** %l0
...
merge11:
  ...
  %t47 = call i8* @char_at__string_utils(i8* %t45, double %t46)
  store i8* %t47, i8** %l3
  %t48 = load i8*, i8** %l3
