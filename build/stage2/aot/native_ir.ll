...
merge70:
  %t861 = load i8*, i8** %l23
  %t862 = call i8* @trim_text__native_ir(i8* %t861)
...
merge7:
  ...
  %t203 = call i8* @trim_text__native_ir(i8* %t202)
...
merge7:
  ...
  %t116 = call i8* @trim_text__native_ir(i8* %t115)
  store i8* %t116, i8** %l7
  %t118 = load i8*, i8** %l7
...
merge9:
  ...
  %t200 = call i8* @trim_text__native_ir(i8* %t199)
...
else30:
  ...
  %t478 = call { %NativeEnumVariantLayout*, i64 }* @append_enum_variant_layout__native_ir({ %NativeEnumVariantLayout*, i64 }* %t475, %NativeEnumVariantLayout %t477)
...
merge38:
  ...
  %t445 = call i8* @trim_text__native_ir(i8* %t444)
...
then46:
  ...
  %t538 = call { %NativeEnumVariantLayout*, i64 }* @append_enum_variant_layout__native_ir({ %NativeEnumVariantLayout*, i64 }* %t535, %NativeEnumVariantLayout %t537)
