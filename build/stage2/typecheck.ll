...
then36:
  ...
  %t2519 = bitcast { %SymbolEntry*, i64 }* %bindings to { %SymbolEntry**, i64 }*
  %t2520 = insertvalue %ScopeResult undef, { %SymbolEntry**, i64 }* %t2519, 0
  %t2521 = load { %Diagnostic*, i64 }*, { %Diagnostic*, i64 }** %l22
  %t2522 = bitcast { %Diagnostic*, i64 }* %t2521 to { %Diagnostic**, i64 }*
  %t2523 = insertvalue %ScopeResult %t2520, { %Diagnostic**, i64 }* %t2522, 1
  ret %ScopeResult %t2523
merge37:
  %t2524 = extractvalue %Statement %statement, 0
  %t2525 = getelementptr inbounds [1 x i8], [1 x i8]* @.enum.Statement.variant.default, i32 0, i32 0
  %t2526 = getelementptr inbounds [18 x i8], [18 x i8]* @.enum.Statement.ImportDeclaration.variant, i32 0, i32 0
  %t2527 = icmp eq i32 %t2524, 0
  %t2528 = select i1 %t2527, i8* %t2526, i8* %t2525
  %t2529 = getelementptr inbounds [18 x i8], [18 x i8]* @.enum.Statement.ExportDeclaration.variant, i32 0, i32 0
  %t2530 = icmp eq i32 %t2524, 1
  %t2531 = select i1 %t2530, i8* %t2529, i8* %t2528
  %t2532 = getelementptr inbounds [20 x i8], [20 x i8]* @.enum.Statement.VariableDeclaration.variant, i32 0, i32 0
  %t2533 = icmp eq i32 %t2524, 2
  %t2534 = select i1 %t2533, i8* %t2532, i8* %t2531
  %t2535 = getelementptr inbounds [17 x i8], [17 x i8]* @.enum.Statement.ModelDeclaration.variant, i32 0, i32 0
  %t2536 = icmp eq i32 %t2524, 3
  %t2537 = select i1 %t2536, i8* %t2535, i8* %t2534
  %t2538 = getelementptr inbounds [20 x i8], [20 x i8]* @.enum.Statement.PipelineDeclaration.variant, i32 0, i32 0
  %t2539 = icmp eq i32 %t2524, 4
  %t2540 = select i1 %t2539, i8* %t2538, i8* %t2537
  %t2541 = getelementptr inbounds [16 x i8], [16 x i8]* @.enum.Statement.ToolDeclaration.variant, i32 0, i32 0
  %t2542 = icmp eq i32 %t2524, 5
  %t2543 = select i1 %t2542, i8* %t2541, i8* %t2540
  %t2544 = getelementptr inbounds [16 x i8], [16 x i8]* @.enum.Statement.TestDeclaration.variant, i32 0, i32 0
  %t2545 = icmp eq i32 %t2524, 6
  %t2546 = select i1 %t2545, i8* %t2544, i8* %t2543
  %t2547 = getelementptr inbounds [20 x i8], [20 x i8]* @.enum.Statement.FunctionDeclaration.variant, i32 0, i32 0
  %t2548 = icmp eq i32 %t2524, 7
  %t2549 = select i1 %t2548, i8* %t2547, i8* %t2546
  %t2550 = getelementptr inbounds [18 x i8], [18 x i8]* @.enum.Statement.StructDeclaration.variant, i32 0, i32 0
  %t2551 = icmp eq i32 %t2524, 8
  %t2552 = select i1 %t2551, i8* %t2550, i8* %t2549
  %t2553 = getelementptr inbounds [21 x i8], [21 x i8]* @.enum.Statement.TypeAliasDeclaration.variant, i32 0, i32 0
  %t2554 = icmp eq i32 %t2524, 9
  %t2555 = select i1 %t2554, i8* %t2553, i8* %t2552
  %t2556 = getelementptr inbounds [21 x i8], [21 x i8]* @.enum.Statement.InterfaceDeclaration.variant, i32 0, i32 0
  %t2557 = icmp eq i32 %t2524, 10
  %t2558 = select i1 %t2557, i8* %t2556, i8* %t2555
  %t2559 = getelementptr inbounds [16 x i8], [16 x i8]* @.enum.Statement.EnumDeclaration.variant, i32 0, i32 0
  %t2560 = icmp eq i32 %t2524, 11
  %t2561 = select i1 %t2560, i8* %t2559, i8* %t2558
  %t2562 = getelementptr inbounds [16 x i8], [16 x i8]* @.enum.Statement.PromptStatement.variant, i32 0, i32 0
  %t2563 = icmp eq i32 %t2524, 12
  %t2564 = select i1 %t2563, i8* %t2562, i8* %t2561
  %t2565 = getelementptr inbounds [14 x i8], [14 x i8]* @.enum.Statement.WithStatement.variant, i32 0, i32 0
  %t2566 = icmp eq i32 %t2524, 13
  %t2567 = select i1 %t2566, i8* %t2565, i8* %t2564
  %t2568 = getelementptr inbounds [13 x i8], [13 x i8]* @.enum.Statement.ForStatement.variant, i32 0, i32 0
  %t2569 = icmp eq i32 %t2524, 14
  %t2570 = select i1 %t2569, i8* %t2568, i8* %t2567
  %t2571 = getelementptr inbounds [14 x i8], [14 x i8]* @.enum.Statement.LoopStatement.variant, i32 0, i32 0
  %t2572 = icmp eq i32 %t2524, 15
  %t2573 = select i1 %t2572, i8* %t2571, i8* %t2570
  %t2574 = getelementptr inbounds [15 x i8], [15 x i8]* @.enum.Statement.BreakStatement.variant, i32 0, i32 0
  %t2575 = icmp eq i32 %t2524, 16
  %t2576 = select i1 %t2575, i8* %t2574, i8* %t2573
  %t2577 = getelementptr inbounds [18 x i8], [18 x i8]* @.enum.Statement.ContinueStatement.variant, i32 0, i32 0
  %t2578 = icmp eq i32 %t2524, 17
  %t2579 = select i1 %t2578, i8* %t2577, i8* %t2576
  %t2580 = getelementptr inbounds [15 x i8], [15 x i8]* @.enum.Statement.MatchStatement.variant, i32 0, i32 0
  %t2581 = icmp eq i32 %t2524, 18
  %t2582 = select i1 %t2581, i8* %t2580, i8* %t2579
  %t2583 = getelementptr inbounds [12 x i8], [12 x i8]* @.enum.Statement.IfStatement.variant, i32 0, i32 0
  %t2584 = icmp eq i32 %t2524, 19
  %t2585 = select i1 %t2584, i8* %t2583, i8* %t2582
  %t2586 = getelementptr inbounds [16 x i8], [16 x i8]* @.enum.Statement.ReturnStatement.variant, i32 0, i32 0
  %t2587 = icmp eq i32 %t2524, 20
  %t2588 = select i1 %t2587, i8* %t2586, i8* %t2585
  %t2589 = getelementptr inbounds [20 x i8], [20 x i8]* @.enum.Statement.ExpressionStatement.variant, i32 0, i32 0
  %t2590 = icmp eq i32 %t2524, 21
  %t2591 = select i1 %t2590, i8* %t2589, i8* %t2588
  %t2592 = getelementptr inbounds [8 x i8], [8 x i8]* @.enum.Statement.Unknown.variant, i32 0, i32 0
  %t2593 = icmp eq i32 %t2524, 22
  %t2594 = select i1 %t2593, i8* %t2592, i8* %t2591
  %s2595 = getelementptr inbounds [16 x i8], [16 x i8]* @.str.2595, i32 0, i32 0
  %t2596 = icmp eq i8* %t2594, %s2595
  br i1 %t2596, label %then38, label %merge39
then38:
  %t2597 = bitcast { %SymbolEntry*, i64 }* %bindings to { %SymbolEntry**, i64 }*
  %t2598 = insertvalue %ScopeResult undef, { %SymbolEntry**, i64 }* %t2597, 0
  %t2599 = extractvalue %Statement %statement, 0
  %t2600 = alloca %Statement
  store %Statement %statement, %Statement* %t2600
  %t2601 = getelementptr inbounds %Statement, %Statement* %t2600, i32 0, i32 1
  %t2602 = bitcast [24 x i8]* %t2601 to i8*
  %t2603 = getelementptr inbounds i8, i8* %t2602, i64 8
  %t2604 = bitcast i8* %t2603 to %Block*
  %t2605 = load %Block, %Block* %t2604
  %t2606 = icmp eq i32 %t2599, 4
  %t2607 = select i1 %t2606, %Block %t2605, %Block zeroinitializer
  %t2608 = getelementptr inbounds %Statement, %Statement* %t2600, i32 0, i32 1
  %t2609 = bitcast [24 x i8]* %t2608 to i8*
  %t2610 = getelementptr inbounds i8, i8* %t2609, i64 8
  %t2611 = bitcast i8* %t2610 to %Block*
  %t2612 = load %Block, %Block* %t2611
  %t2613 = icmp eq i32 %t2599, 5
  %t2614 = select i1 %t2613, %Block %t2612, %Block %t2607
  %t2615 = getelementptr inbounds %Statement, %Statement* %t2600, i32 0, i32 1
  %t2616 = bitcast [40 x i8]* %t2615 to i8*
  %t2617 = getelementptr inbounds i8, i8* %t2616, i64 16
  %t2618 = bitcast i8* %t2617 to %Block*
  %t2619 = load %Block, %Block* %t2618
  %t2620 = icmp eq i32 %t2599, 6
  %t2621 = select i1 %t2620, %Block %t2619, %Block %t2614
  %t2622 = getelementptr inbounds %Statement, %Statement* %t2600, i32 0, i32 1
  %t2623 = bitcast [24 x i8]* %t2622 to i8*
  %t2624 = getelementptr inbounds i8, i8* %t2623, i64 8
  %t2625 = bitcast i8* %t2624 to %Block*
  %t2626 = load %Block, %Block* %t2625
  %t2627 = icmp eq i32 %t2599, 7
  %t2628 = select i1 %t2627, %Block %t2626, %Block %t2621
  %t2629 = getelementptr inbounds %Statement, %Statement* %t2600, i32 0, i32 1
  %t2630 = bitcast [40 x i8]* %t2629 to i8*
  %t2631 = getelementptr inbounds i8, i8* %t2630, i64 24
  %t2632 = bitcast i8* %t2631 to %Block*
  %t2633 = load %Block, %Block* %t2632
  %t2634 = icmp eq i32 %t2599, 12
  %t2635 = select i1 %t2634, %Block %t2633, %Block %t2628
  %t2636 = getelementptr inbounds %Statement, %Statement* %t2600, i32 0, i32 1
  %t2637 = bitcast [24 x i8]* %t2636 to i8*
  %t2638 = getelementptr inbounds i8, i8* %t2637, i64 8
  %t2639 = bitcast i8* %t2638 to %Block*
  %t2640 = load %Block, %Block* %t2639
  %t2641 = icmp eq i32 %t2599, 13
  %t2642 = select i1 %t2641, %Block %t2640, %Block %t2635
  %t2643 = getelementptr inbounds %Statement, %Statement* %t2600, i32 0, i32 1
  ...
  %t2648 = icmp eq i32 %t2599, 14
  %t2649 = select i1 %t2648, %Block %t2647, %Block %t2642
  %t2650 = getelementptr inbounds %Statement, %Statement* %t2600, i32 0, i32 1
  %t2651 = bitcast [16 x i8]* %t2650 to i8*
  %t2652 = bitcast i8* %t2651 to %Block*
  %t2653 = load %Block, %Block* %t2652
  %t2654 = icmp eq i32 %t2599, 15
  %t2655 = select i1 %t2654, %Block %t2653, %Block %t2649
  %t2656 = call { %Diagnostic*, i64 }* @check_block(%Block %t2655, { %SymbolEntry*, i64 }* %bindings, { %Statement*, i64 }* %interfaces)
  %t2657 = bitcast { %Diagnostic*, i64 }* %t2656 to { %Diagnostic**, i64 }*
  %t2658 = insertvalue %ScopeResult %t2598, { %Diagnostic**, i64 }* %t2657, 1
  ret %ScopeResult %t2658
merge39:
  %t2659 = extractvalue %Statement %statement, 0
  %t2660 = getelementptr inbounds [1 x i8], [1 x i8]* @.enum.Statement.variant.default, i32 0, i32 0
  %t2661 = getelementptr inbounds [18 x i8], [18 x i8]* @.enum.Statement.ImportDeclaration.variant, i32 0, i32 0
  %t2662 = icmp eq i32 %t2659, 0
  %t2663 = select i1 %t2662, i8* %t2661, i8* %t2660
  %t2664 = getelementptr inbounds [18 x i8], [18 x i8]* @.enum.Statement.ExportDeclaration.variant, i32 0, i32 0
  %t2665 = icmp eq i32 %t2659, 1
  %t2666 = select i1 %t2665, i8* %t2664, i8* %t2663
  %t2667 = getelementptr inbounds [20 x i8], [20 x i8]* @.enum.Statement.VariableDeclaration.variant, i32 0, i32 0
  %t2668 = icmp eq i32 %t2659, 2
  %t2669 = select i1 %t2668, i8* %t2667, i8* %t2666
  %t2670 = getelementptr inbounds [17 x i8], [17 x i8]* @.enum.Statement.ModelDeclaration.variant, i32 0, i32 0
  %t2671 = icmp eq i32 %t2659, 3
  %t2672 = select i1 %t2671, i8* %t2670, i8* %t2669
  %t2673 = getelementptr inbounds [20 x i8], [20 x i8]* @.enum.Statement.PipelineDeclaration.variant, i32 0, i32 0
  %t2674 = icmp eq i32 %t2659, 4
  %t2675 = select i1 %t2674, i8* %t2673, i8* %t2672
  %t2676 = getelementptr inbounds [16 x i8], [16 x i8]* @.enum.Statement.ToolDeclaration.variant, i32 0, i32 0
  %t2677 = icmp eq i32 %t2659, 5
  %t2678 = select i1 %t2677, i8* %t2676, i8* %t2675
  %t2679 = getelementptr inbounds [16 x i8], [16 x i8]* @.enum.Statement.TestDeclaration.variant, i32 0, i32 0
  %t2680 = icmp eq i32 %t2659, 6
  %t2681 = select i1 %t2680, i8* %t2679, i8* %t2678
  %t2682 = getelementptr inbounds [20 x i8], [20 x i8]* @.enum.Statement.FunctionDeclaration.variant, i32 0, i32 0
  %t2683 = icmp eq i32 %t2659, 7
  %t2684 = select i1 %t2683, i8* %t2682, i8* %t2681
  %t2685 = getelementptr inbounds [18 x i8], [18 x i8]* @.enum.Statement.StructDeclaration.variant, i32 0, i32 0
  %t2686 = icmp eq i32 %t2659, 8
  %t2687 = select i1 %t2686, i8* %t2685, i8* %t2684
  %t2688 = getelementptr inbounds [21 x i8], [21 x i8]* @.enum.Statement.TypeAliasDeclaration.variant, i32 0, i32 0
  %t2689 = icmp eq i32 %t2659, 9
  %t2690 = select i1 %t2689, i8* %t2688, i8* %t2687
  %t2691 = getelementptr inbounds [21 x i8], [21 x i8]* @.enum.Statement.InterfaceDeclaration.variant, i32 0, i32 0
  %t2692 = icmp eq i32 %t2659, 10
  %t2693 = select i1 %t2692, i8* %t2691, i8* %t2690
  %t2694 = getelementptr inbounds [16 x i8], [16 x i8]* @.enum.Statement.EnumDeclaration.variant, i32 0, i32 0
  %t2695 = icmp eq i32 %t2659, 11
  %t2696 = select i1 %t2695, i8* %t2694, i8* %t2693
  %t2697 = getelementptr inbounds [16 x i8], [16 x i8]* @.enum.Statement.PromptStatement.variant, i32 0, i32 0
  %t2698 = icmp eq i32 %t2659, 12
  %t2699 = select i1 %t2698, i8* %t2697, i8* %t2696
  %t2700 = getelementptr inbounds [14 x i8], [14 x i8]* @.enum.Statement.WithStatement.variant, i32 0, i32 0
  %t2701 = icmp eq i32 %t2659, 13
  %t2702 = select i1 %t2701, i8* %t2700, i8* %t2699
  %t2703 = getelementptr inbounds [13 x i8], [13 x i8]* @.enum.Statement.ForStatement.variant, i32 0, i32 0
  %t2704 = icmp eq i32 %t2659, 14
  %t2705 = select i1 %t2704, i8* %t2703, i8* %t2702
  %t2706 = getelementptr inbounds [14 x i8], [14 x i8]* @.enum.Statement.LoopStatement.variant, i32 0, i32 0
  %t2707 = icmp eq i32 %t2659, 15
  %t2708 = select i1 %t2707, i8* %t2706, i8* %t2705
  %t2709 = getelementptr inbounds [15 x i8], [15 x i8]* @.enum.Statement.BreakStatement.variant, i32 0, i32 0
  %t2710 = icmp eq i32 %t2659, 16
  %t2711 = select i1 %t2710, i8* %t2709, i8* %t2708
  %t2712 = getelementptr inbounds [18 x i8], [18 x i8]* @.enum.Statement.ContinueStatement.variant, i32 0, i32 0
  %t2713 = icmp eq i32 %t2659, 17
  %t2714 = select i1 %t2713, i8* %t2712, i8* %t2711
  %t2715 = getelementptr inbounds [15 x i8], [15 x i8]* @.enum.Statement.MatchStatement.variant, i32 0, i32 0
  %t2716 = icmp eq i32 %t2659, 18
  %t2717 = select i1 %t2716, i8* %t2715, i8* %t2714
  %t2718 = getelementptr inbounds [12 x i8], [12 x i8]* @.enum.Statement.IfStatement.variant, i32 0, i32 0
  %t2719 = icmp eq i32 %t2659, 19
  %t2720 = select i1 %t2719, i8* %t2718, i8* %t2717
  %t2721 = getelementptr inbounds [16 x i8], [16 x i8]* @.enum.Statement.ReturnStatement.variant, i32 0, i32 0
  %t2722 = icmp eq i32 %t2659, 20
  %t2723 = select i1 %t2722, i8* %t2721, i8* %t2720
  %t2724 = getelementptr inbounds [20 x i8], [20 x i8]* @.enum.Statement.ExpressionStatement.variant, i32 0, i32 0
  %t2725 = icmp eq i32 %t2659, 21
  %t2726 = select i1 %t2725, i8* %t2724, i8* %t2723
  %t2727 = getelementptr inbounds [8 x i8], [8 x i8]* @.enum.Statement.Unknown.variant, i32 0, i32 0
  %t2728 = icmp eq i32 %t2659, 22
  %t2729 = select i1 %t2728, i8* %t2727, i8* %t2726
  %s2730 = getelementptr inbounds [21 x i8], [21 x i8]* @.str.2730, i32 0, i32 0
  %t2731 = icmp eq i8* %t2729, %s2730
  br i1 %t2731, label %then40, label %merge41
then40:
  %t2732 = extractvalue %Statement %statement, 0
  %t2733 = alloca %Statement
  store %Statement %statement, %Statement* %t2733
  %t2734 = getelementptr inbounds %Statement, %Statement* %t2733, i32 0, i32 1
  %t2735 = bitcast [48 x i8]* %t2734 to i8*
  %t2736 = bitcast i8* %t2735 to i8**
  %t2737 = load i8*, i8** %t2736
  %t2738 = icmp eq i32 %t2732, 2
  %t2739 = select i1 %t2738, i8* %t2737, i8* null
  %t2740 = getelementptr inbounds %Statement, %Statement* %t2733, i32 0, i32 1
  %t2741 = bitcast [48 x i8]* %t2740 to i8*
  %t2742 = bitcast i8* %t2741 to i8**
  %t2743 = load i8*, i8** %t2742
  %t2744 = icmp eq i32 %t2732, 3
  %t2745 = select i1 %t2744, i8* %t2743, i8* %t2739
  %t2746 = getelementptr inbounds %Statement, %Statement* %t2733, i32 0, i32 1
  %t2747 = bitcast [40 x i8]* %t2746 to i8*
  %t2748 = bitcast i8* %t2747 to i8**
  %t2749 = load i8*, i8** %t2748
  %t2750 = icmp eq i32 %t2732, 6
  %t2751 = select i1 %t2750, i8* %t2749, i8* %t2745
  %t2752 = getelementptr inbounds %Statement, %Statement* %t2733, i32 0, i32 1
  %t2753 = bitcast [56 x i8]* %t2752 to i8*
  %t2754 = bitcast i8* %t2753 to i8**
  %t2755 = load i8*, i8** %t2754
  %t2756 = icmp eq i32 %t2732, 8
  %t2757 = select i1 %t2756, i8* %t2755, i8* %t2751
  %t2758 = getelementptr inbounds %Statement, %Statement* %t2733, i32 0, i32 1
  %t2759 = bitcast [40 x i8]* %t2758 to i8*
  %t2760 = bitcast i8* %t2759 to i8**
  %t2761 = load i8*, i8** %t2760
  %t2762 = icmp eq i32 %t2732, 9
  %t2763 = select i1 %t2762, i8* %t2761, i8* %t2757
  %t2764 = getelementptr inbounds %Statement, %Statement* %t2733, i32 0, i32 1
  %t2765 = bitcast [40 x i8]* %t2764 to i8*
  %t2766 = bitcast i8* %t2765 to i8**
  %t2767 = load i8*, i8** %t2766
  %t2768 = icmp eq i32 %t2732, 10
  %t2769 = select i1 %t2768, i8* %t2767, i8* %t2763
  %t2770 = getelementptr inbounds %Statement, %Statement* %t2733, i32 0, i32 1
  %t2771 = bitcast [40 x i8]* %t2770 to i8*
  %t2772 = bitcast i8* %t2771 to i8**
  %t2773 = load i8*, i8** %t2772
  %t2774 = icmp eq i32 %t2732, 11
  %t2775 = select i1 %t2774, i8* %t2773, i8* %t2769
  %s2776 = getelementptr inbounds [5 x i8], [5 x i8]* @.str.2776, i32 0, i32 0
  %t2777 = extractvalue %Statement %statement, 0
  %t2778 = alloca %Statement
  store %Statement %statement, %Statement* %t2778
  %t2779 = getelementptr inbounds %Statement, %Statement* %t2778, i32 0, i32 1
  %t2780 = bitcast [48 x i8]* %t2779 to i8*
  %t2781 = getelementptr inbounds i8, i8* %t2780, i64 8
  %t2782 = bitcast i8* %t2781 to %SourceSpan**
  %t2783 = load %SourceSpan*, %SourceSpan** %t2782
  %t2784 = icmp eq i32 %t2777, 3
  %t2785 = select i1 %t2784, %SourceSpan* %t2783, %SourceSpan* null
  %t2786 = getelementptr inbounds %Statement, %Statement* %t2778, i32 0, i32 1
  %t2787 = bitcast [40 x i8]* %t2786 to i8*
  %t2788 = getelementptr inbounds i8, i8* %t2787, i64 8
  %t2789 = bitcast i8* %t2788 to %SourceSpan**
  %t2790 = load %SourceSpan*, %SourceSpan** %t2789
  %t2791 = icmp eq i32 %t2777, 6
  %t2792 = select i1 %t2791, %SourceSpan* %t2790, %SourceSpan* %t2785
  %t2793 = getelementptr inbounds %Statement, %Statement* %t2778, i32 0, i32 1
  %t2794 = bitcast [56 x i8]* %t2793 to i8*
  %t2795 = getelementptr inbounds i8, i8* %t2794, i64 8
  %t2796 = bitcast i8* %t2795 to %SourceSpan**
  %t2797 = load %SourceSpan*, %SourceSpan** %t2796
  %t2798 = icmp eq i32 %t2777, 8
  %t2799 = select i1 %t2798, %SourceSpan* %t2797, %SourceSpan* %t2792
  %t2800 = getelementptr inbounds %Statement, %Statement* %t2778, i32 0, i32 1
  %t2801 = bitcast [40 x i8]* %t2800 to i8*
  %t2802 = getelementptr inbounds i8, i8* %t2801, i64 8
  %t2803 = bitcast i8* %t2802 to %SourceSpan**
  %t2804 = load %SourceSpan*, %SourceSpan** %t2803
  %t2805 = icmp eq i32 %t2777, 9
  %t2806 = select i1 %t2805, %SourceSpan* %t2804, %SourceSpan* %t2799
  %t2807 = getelementptr inbounds %Statement, %Statement* %t2778, i32 0, i32 1
  %t2808 = bitcast [40 x i8]* %t2807 to i8*
  %t2809 = getelementptr inbounds i8, i8* %t2808, i64 8
  %t2810 = bitcast i8* %t2809 to %SourceSpan**
  %t2811 = load %SourceSpan*, %SourceSpan** %t2810
  %t2812 = icmp eq i32 %t2777, 10
  %t2813 = select i1 %t2812, %SourceSpan* %t2811, %SourceSpan* %t2806
  %t2814 = getelementptr inbounds %Statement, %Statement* %t2778, i32 0, i32 1
  %t2815 = bitcast [40 x i8]* %t2814 to i8*
  %t2816 = getelementptr inbounds i8, i8* %t2815, i64 8
  %t2817 = bitcast i8* %t2816 to %SourceSpan**
  %t2818 = load %SourceSpan*, %SourceSpan** %t2817
  %t2819 = icmp eq i32 %t2777, 11
  %t2820 = select i1 %t2819, %SourceSpan* %t2818, %SourceSpan* %t2813
  %t2821 = bitcast %SourceSpan* %t2820 to i8*
  %t2822 = call %ScopeResult @register_local_symbol({ %SymbolEntry*, i64 }* %bindings, i8* %t2775, i8* %s2776, i8* %t2821)
  store %ScopeResult %t2822, %ScopeResult* %l23
  %t2823 = load %ScopeResult, %ScopeResult* %l23
  %t2824 = extractvalue %ScopeResult %t2823, 1
  %t2825 = extractvalue %Statement %statement, 0
  %t2826 = alloca %Statement
  store %Statement %statement, %Statement* %t2826
  %t2827 = getelementptr inbounds %Statement, %Statement* %t2826, i32 0, i32 1
  %t2828 = bitcast [56 x i8]* %t2827 to i8*
  %t2829 = getelementptr inbounds i8, i8* %t2828, i64 16
  %t2830 = bitcast i8* %t2829 to { %TypeParameter**, i64 }**
  %t2831 = load { %TypeParameter**, i64 }*, { %TypeParameter**, i64 }** %t2830
  %t2832 = icmp eq i32 %t2825, 8
  %t2833 = select i1 %t2832, { %TypeParameter**, i64 }* %t2831, { %TypeParameter**, i64 }* null
  %t2834 = getelementptr inbounds %Statement, %Statement* %t2826, i32 0, i32 1
  %t2835 = bitcast [40 x i8]* %t2834 to i8*
  %t2836 = getelementptr inbounds i8, i8* %t2835, i64 16
  %t2837 = bitcast i8* %t2836 to { %TypeParameter**, i64 }**
  %t2838 = load { %TypeParameter**, i64 }*, { %TypeParameter**, i64 }** %t2837
  %t2839 = icmp eq i32 %t2825, 9
  %t2840 = select i1 %t2839, { %TypeParameter**, i64 }* %t2838, { %TypeParameter**, i64 }* %t2833
  %t2841 = getelementptr inbounds %Statement, %Statement* %t2826, i32 0, i32 1
  %t2842 = bitcast [40 x i8]* %t2841 to i8*
  %t2843 = getelementptr inbounds i8, i8* %t2842, i64 16
  %t2844 = bitcast i8* %t2843 to { %TypeParameter**, i64 }**
  %t2845 = load { %TypeParameter**, i64 }*, { %TypeParameter**, i64 }** %t2844
  %t2846 = icmp eq i32 %t2825, 10
  %t2847 = select i1 %t2846, { %TypeParameter**, i64 }* %t2845, { %TypeParameter**, i64 }* %t2840
  %t2848 = getelementptr inbounds %Statement, %Statement* %t2826, i32 0, i32 1
  %t2849 = bitcast [40 x i8]* %t2848 to i8*
  %t2850 = getelementptr inbounds i8, i8* %t2849, i64 16
  %t2851 = bitcast i8* %t2850 to { %TypeParameter**, i64 }**
  %t2852 = load { %TypeParameter**, i64 }*, { %TypeParameter**, i64 }** %t2851
  %t2853 = icmp eq i32 %t2825, 11
  %t2854 = select i1 %t2853, { %TypeParameter**, i64 }* %t2852, { %TypeParameter**, i64 }* %t2847
  %t2855 = bitcast { %TypeParameter**, i64 }* %t2854 to { %TypeParameter*, i64 }*
  %t2856 = call { %Diagnostic*, i64 }* @check_type_parameters({ %TypeParameter*, i64 }* %t2855)
  %t2857 = bitcast { %Diagnostic**, i64 }* %t2824 to { i8**, i64 }*
  %t2858 = bitcast { %Diagnostic*, i64 }* %t2856 to { i8**, i64 }*
  %t2859 = call { i8**, i64 }* @sailfin_runtime_concat({ i8**, i64 }* %t2857, { i8**, i64 }* %t2858)
  store { i8**, i64 }* %t2859, { i8**, i64 }** %l24
  %t2860 = load %ScopeResult, %ScopeResult* %l23
  %t2861 = extractvalue %ScopeResult %t2860, 0
  %t2862 = insertvalue %ScopeResult undef, { %SymbolEntry**, i64 }* %t2861, 0
  %t2863 = load { i8**, i64 }*, { i8**, i64 }** %l24
  %t2864 = bitcast { i8**, i64 }* %t2863 to { %Diagnostic**, i64 }*
  %t2865 = insertvalue %ScopeResult %t2862, { %Diagnostic**, i64 }* %t2864, 1
  ret %ScopeResult %t2865
merge41:
  %t2866 = bitcast { %SymbolEntry*, i64 }* %bindings to { %SymbolEntry**, i64 }*
  %t2867 = insertvalue %ScopeResult undef, { %SymbolEntry**, i64 }* %t2866, 0
  %t2868 = alloca [0 x %Diagnostic*]
  %t2869 = getelementptr [0 x %Diagnostic*], [0 x %Diagnostic*]* %t2868, i32 0, i32 0
  %t2870 = alloca { %Diagnostic**, i64 }
  %t2871 = getelementptr { %Diagnostic**, i64 }, { %Diagnostic**, i64 }* %t2870, i32 0, i32 0
  store %Diagnostic** %t2869, %Diagnostic*** %t2871
  %t2872 = getelementptr { %Diagnostic**, i64 }, { %Diagnostic**, i64 }* %t2870, i32 0, i32 1
  store i64 0, i64* %t2872
  %t2873 = insertvalue %ScopeResult %t2867, { %Diagnostic**, i64 }* %t2870, 1
  ret %ScopeResult %t2873
}
...
forbody7:
  ...
  %t130 = call { %Diagnostic*, i64 }* @validate_interface_annotation(i8* %t126, %Statement zeroinitializer, %TypeAnnotation %t129)
