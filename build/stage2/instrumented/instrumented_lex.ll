...
then19:
  call void @stage2_debug_marker(i64 1005)
...
then21:
  call void @stage2_debug_marker(i64 1006)
...
merge28:
  call void @stage2_debug_marker(i64 1008)
...
then31:
  call void @stage2_debug_marker(i64 1009)
...
loop.body34:
  call void @stage2_debug_marker(i64 1010)
