...
declare { i8**, i64 }* @append_unique({ i8**, i64 }* %values, i8* %value)
...
merge5:
  ...
  %t68 = load i8*, i8** %l0
  %t69 = load i8*, i8** %l4
  %t70 = call i1 @starts_with(i8* %t68, i8* %t69)
  %t71 = load i8*, i8** %l0
...
define private i8* @join_with_separator({ i8**, i64 }* %items, i8* %separator) {
block.entry:
  %l0 = alloca i8*
  %l1 = alloca double
...
define private i8* @slice_text(i8* %value, double %start, double %end) {
block.entry:
  %l0 = alloca double
  %l1 = alloca double
  %l2 = alloca i8*
...
define private i1 @is_whitespace(i8* %ch) {
block.entry:
  %t1 = load i8, i8* %ch
  %t2 = icmp eq i8 %t1, 32
...
define private i1 @contains_string({ i8**, i64 }* %items, i8* %candidate) {
block.entry:
  %l0 = alloca i64
  %l1 = alloca i8*
