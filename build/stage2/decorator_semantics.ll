...
merge5:
  ...
  %t25 = bitcast { i8**, i64 }* %t24 to { %DecoratorArgument*, i64 }*
  ...
  %t32 = bitcast { %DecoratorArgumentInfo*, i64 }* %t31 to { i8**, i64 }*
  %t33 = insertvalue %DecoratorInfo %t30, { i8**, i64 }* %t32, 1
...
merge5:
  ...
  %t31 = insertvalue %DecoratorArgumentInfo %t29, i8* null, 1
...
merge13:
  store i64 0, i64* %l3
  %t32 = load i64, i64* %l3
  %t33 = call i1 @sailfin_runtime_is_whitespace_char(i64 %t32)
...
afterloop11:
  ...
  %t44 = call i8* @slice_text(i8* %value, double %t42, double %t43)
  ret i8* %t44
}
...
merge5:
  ...
  br label %merge3
merge3:
  %t14 = phi double [ %t13, %then2 ], [ %t8, %entry ]
  store double %t14, double* %l1
  %t15 = load i1, i1* %l0
  %t16 = load double, double* %l1
  br label %loop.header6
loop.header6:
  %t51 = phi i1 [ %t15, %entry ], [ %t49, %loop.latch8 ]
  %t52 = phi double [ %t16, %entry ], [ %t50, %loop.latch8 ]
  store i1 %t51, i1* %l0
...
merge13:
  %t40 = load i64, i64* %l2
  %t41 = call i1 @sailfin_runtime_is_decimal_digit(i64 %t40)
  %t42 = xor i1 %t41, 1
  %t43 = load i1, i1* %l0
  %t44 = load double, double* %l1
  %t45 = load i64, i64* %l2
  br i1 %t42, label %then16, label %merge17
then16:
  ret i1 0
merge17:
