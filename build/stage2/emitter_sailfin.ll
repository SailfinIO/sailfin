...
then10:
  ...
  %t151 = call %TextBuilder @builder_emit_line(%TextBuilder %t149, i8* %s150)
...
logical_and_merge_190:
  ...
  %t203 = call %TextBuilder @emit_statement(%TextBuilder %t201, %Statement %t202)
...
afterloop15:
  ...
  %t218 = call i8* @builder_to_string(%TextBuilder %t217)
