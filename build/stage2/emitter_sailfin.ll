...
block.entry:
  ...
  store i8* %t4, i8** %l1
  %t5 = load i8*, i8** %l1
  %t6 = call %TextBuilder @builder_emit_line(%TextBuilder %builder, i8* %t5)
  ret %TextBuilder %t6
}
...
then4:
  ...
  %t183 = call i8* @format_expression(%Expression %t182)
  %t184 = add i64 0, 2
  ...
  %t188 = call %TextBuilder @builder_emit_line(%TextBuilder %builder, i8* %t187)
...
then6:
  %t262 = call %TextBuilder @emit_variable(%TextBuilder %builder, %Statement %statement)
...
then8:
  %t336 = call %TextBuilder @emit_prompt(%TextBuilder %builder, %Statement %statement)
...
then10:
  %t410 = call %TextBuilder @emit_with(%TextBuilder %builder, %Statement %statement)
...
then12:
  %t484 = call %TextBuilder @emit_if(%TextBuilder %builder, %Statement %statement)
...
then14:
  %t558 = call %TextBuilder @emit_for(%TextBuilder %builder, %Statement %statement)
...
then16:
  %t632 = call %TextBuilder @emit_test(%TextBuilder %builder, %Statement %statement)
...
then18:
  ...
  store i8* %t717, i8** %l1
  %t718 = load i8*, i8** %l1
  %t719 = call %TextBuilder @builder_emit_line(%TextBuilder %builder, i8* %t718)
...
then20:
  ...
  %t977 = call %TextBuilder @emit_function(%TextBuilder %builder, %FunctionSignature %t812, %Block %t869, { %Decorator*, i64 }* %t976)
...
then22:
  %t1051 = call %TextBuilder @emit_match(%TextBuilder %builder, %Statement %statement)
...
merge23:
  ...
  %t1125 = call %TextBuilder @builder_emit_line(%TextBuilder %builder, i8* %t1124)
