...
then10:
  ...
  %t158 = call %TextBuilder @builder_emit_line(%TextBuilder %t155, i8* %t156)
...
logical_and_merge_197:
  ...
  %t210 = call %TextBuilder @emit_statement(%TextBuilder %t208, %Statement %t209)
...
afterloop15:
  ...
  %t225 = call i8* @builder_to_string(%TextBuilder %t224)
...
then6:
  ...
  %t549 = call %TextBuilder @emit_function(%TextBuilder %builder, %FunctionSignature %t378, %Block %t441, { %Decorator*, i64 }* %t548)
...
then8:
  %t627 = call %TextBuilder @emit_struct(%TextBuilder %builder, %Statement %statement)
...
then14:
  %t1245 = call %TextBuilder @emit_test(%TextBuilder %builder, %Statement %statement)
...
then16:
  %t1323 = call %TextBuilder @emit_model(%TextBuilder %builder, %Statement %statement)
...
then18:
  %t1401 = call %TextBuilder @emit_type_alias(%TextBuilder %builder, %Statement %statement)
...
then20:
  %t1479 = call %TextBuilder @emit_interface(%TextBuilder %builder, %Statement %statement)
...
then22:
  %t1557 = call %TextBuilder @emit_enum(%TextBuilder %builder, %Statement %statement)
...
then24:
  ...
  %t1648 = load i8*, i8** %l0
  %t1649 = call %TextBuilder @builder_emit_line(%TextBuilder %builder, i8* %t1648)
...
merge25:
  ...
  %t1727 = call %TextBuilder @builder_emit_line(%TextBuilder %builder, i8* %t1726)
...
then2:
  ...
  %t92 = call %TextBuilder @builder_emit_line(%TextBuilder %builder, i8* %t90)
  ret %TextBuilder %t92
merge3:
  ...
  %t101 = call %TextBuilder @builder_emit_line(%TextBuilder %builder, i8* %t100)
  ret %TextBuilder %t101
merge1:
  %t102 = extractvalue %Statement %statement, 0
  %t103 = getelementptr inbounds [1 x i8], [1 x i8]* @.enum.Statement.variant.default, i32 0, i32 0
...
then4:
  ...
  %t286 = call %TextBuilder @emit_decorators(%TextBuilder %builder, { %Decorator*, i64 }* %t285)
...
then6:
  ...
  %t433 = call %TextBuilder @builder_emit_line(%TextBuilder %builder, i8* %t431)
...
then8:
  ...
  %t513 = call %TextBuilder @builder_emit_line(%TextBuilder %builder, i8* %t511)
...
then10:
  ...
  %t605 = call i8* @format_expression(%Expression %t604)
  %t606 = add i64 0, 2
  ...
  %t610 = call %TextBuilder @builder_emit_line(%TextBuilder %builder, i8* %t609)
...
then12:
  %t688 = call %TextBuilder @emit_variable(%TextBuilder %builder, %Statement %statement)
...
then14:
  %t766 = call %TextBuilder @emit_prompt(%TextBuilder %builder, %Statement %statement)
...
then16:
  %t844 = call %TextBuilder @emit_with(%TextBuilder %builder, %Statement %statement)
...
then18:
  %t922 = call %TextBuilder @emit_if(%TextBuilder %builder, %Statement %statement)
...
then20:
  ...
  %t1063 = call %TextBuilder @emit_block(%TextBuilder %builder, %Block %t1062)
...
then22:
  %t1141 = call %TextBuilder @emit_for(%TextBuilder %builder, %Statement %statement)
...
then24:
  %t1219 = call %TextBuilder @emit_test(%TextBuilder %builder, %Statement %statement)
...
then26:
  ...
  %t1310 = load i8*, i8** %l2
  %t1311 = call %TextBuilder @builder_emit_line(%TextBuilder %builder, i8* %t1310)
...
then28:
  ...
  %t1579 = call %TextBuilder @emit_function(%TextBuilder %builder, %FunctionSignature %t1408, %Block %t1471, { %Decorator*, i64 }* %t1578)
...
then30:
  %t1657 = call %TextBuilder @emit_match(%TextBuilder %builder, %Statement %statement)
...
merge31:
  ...
  %t1735 = call %TextBuilder @builder_emit_line(%TextBuilder %builder, i8* %t1734)
...
block.entry:
  ...
  %t189 = call %TextBuilder @builder_emit_line(%TextBuilder %t185, i8* %t187)
...
then4:
  ...
  %t101 = call i8* @format_expression(%Expression %t100)
...
merge7:
  ...
  %t134 = call %TextBuilder @emit_else_branch(%TextBuilder %t131, %ElseBranch %t133)
  ret %TextBuilder %t134
merge5:
  %t135 = call i8* @malloc(i64 5)
  %t136 = bitcast i8* %t135 to [5 x i8]*
  store [5 x i8] c"else\00", [5 x i8]* %t136
  %t137 = call %TextBuilder @builder_emit_line(%TextBuilder %builder, i8* %t135)
...
then4:
  ...
  %t191 = call i8* @format_expression(%Expression %t190)
  %t192 = add i64 0, 2
