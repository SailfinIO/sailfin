...
define void @text_char_at(i8* %value, double %index, i8** %out_result) {
block.entry:
  %t0 = sitofp i64 0 to double
...
; NOTE: Returns string via output parameter %out_result
define void @maybe_trim_trailing(i8* %value, i8** %out_result) {
block.entry:
  %l0 = alloca i8*
...
; NOTE: Returns string via output parameter %out_result
define void @parse_function_name(i8* %header, i8** %out_result) {
block.entry:
  %l0 = alloca i8*
  %l1 = alloca double
  %l2 = alloca i8*
...
; NOTE: Returns string via output parameter %out_result
define void @strip_generics(i8* %name, i8** %out_result) {
block.entry:
  %l0 = alloca i8*
  %l1 = alloca double
  %l2 = alloca double
...
; NOTE: Returns string via output parameter %out_result
define void @strip_prefix(i8* %value, i8* %prefix, i8** %out_result) {
block.entry:
...
; NOTE: Returns string via output parameter %out_result
define void @strip_quotes(i8* %value, i8** %out_result) {
block.entry:
  %l0 = alloca i8
  %l1 = alloca i8
  %l2 = alloca i1
