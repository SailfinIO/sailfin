...
merge5:
  ...
  %t19 = call i1 @strings_equal(i8* %t17, i8* %s18)
...
merge9:
  ...
  %t156 = call i1 @strings_equal(i8* %line, i8* %s155)
...
merge13:
  ...
  %t178 = call i1 @strings_equal(i8* %line, i8* %s177)
...
merge15:
  ...
  %t200 = call i1 @strings_equal(i8* %line, i8* %s199)
...
merge17:
  ...
  %t222 = call i1 @strings_equal(i8* %line, i8* %s221)
...
merge19:
  ...
  %t244 = call i1 @strings_equal(i8* %line, i8* %s243)
...
merge25:
  ...
  %t317 = call i1 @strings_equal(i8* %line, i8* %s316)
...
merge11:
  ...
  %t233 = call i1 @strings_equal(i8* %t231, i8* %s232)
...
then16:
  ...
  %t319 = call i1 @strings_equal(i8* %t317, i8* %s318)
...
merge56:
  ...
  %t1047 = call i1 @strings_equal(i8* %t1045, i8* %s1046)
...
merge13:
  ...
  %t227 = call i1 @strings_equal(i8* %t225, i8* %s226)
  %t228 = load { i8**, i64 }*, { i8**, i64 }** %l0
  %t229 = load i8*, i8** %l1
  %t230 = load i8*, i8** %l2
  %t231 = load i8*, i8** %l3
...
merge17:
  ...
  %t722 = call i1 @strings_equal(i8* %t720, i8* %s721)
