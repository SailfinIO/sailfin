...
Expression.Identifier = Expression.variant('Identifier', ['name'])
Expression.NumberLiteral = Expression.variant('NumberLiteral', ['value'])
Expression.StringLiteral = Expression.variant('StringLiteral', ['value'])
Expression.BooleanLiteral = Expression.variant('BooleanLiteral', ['value'])
Expression.NullLiteral = Expression.variant('NullLiteral', [])
Expression.Unary = Expression.variant('Unary', ['operator', 'operand'])
Expression.Binary = Expression.variant('Binary', ['operator', 'left', 'right'])
Expression.Member = Expression.variant('Member', ['object', 'member'])
Expression.Call = Expression.variant('Call', ['callee', 'arguments'])
Expression.Index = Expression.variant('Index', ['sequence', 'index'])
Expression.Array = Expression.variant('Array', ['elements'])
Expression.Object = Expression.variant('Object', ['fields'])
Expression.Struct = Expression.variant('Struct', ['type_name', 'fields'])
Expression.Lambda = Expression.variant('Lambda', ['parameters', 'body', 'return_type'])
Expression.Range = Expression.variant('Range', ['start', 'end'])
