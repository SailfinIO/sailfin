...
Statement = runtime.enum_define_variant(Statement, 'ImportDeclaration', ['import_specifiers', 'source'])
Statement = runtime.enum_define_variant(Statement, 'ExportDeclaration', ['export_specifiers', 'source'])
...
Statement = runtime.enum_define_variant(Statement, 'TryStatement', ['try_block', 'catch_name', 'catch_name_token', 'catch_block', 'finally_block'])
