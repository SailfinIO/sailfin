...
from compiler.build.llvm.expression_lowering_stage2.core import lower_expression, coerce_operand_to_type, parse_member_access, parse_index_expression, find_local_binding, analyze_value_ownership, detect_borrow_conflicts, infer_borrow_base_scope, append_lifetime_region, append_lifetime_release_event, make_lifetime_region_metadata
...
from ..type_mapping import map_type_annotation, map_return_type, map_parameter_type, map_local_type, map_struct_type_annotation, map_struct_field_annotation, unwrap_move_wrapper, ends_with_pointer_suffix, strip_pointer_suffix, layout_annotation_requires_pointer, layout_annotation_base_type, annotation_is_array, layout_annotation_represents_user_value, is_copy_type, array_struct_type_for_element
