...
- **Toolchain version pinning — Phase 1** (SFEP-0046, SFN-167). `capsule.toml`
  ...
  **Phase 2 (auto-fetch + re-exec dispatch, `sfn toolchain install`,
  `SAILFIN_TOOLCHAIN=auto`; SFN-168/SFN-172) is not implemented** — SFEP-0046
  stays `Accepted`, not `Implemented`, until it ships.
