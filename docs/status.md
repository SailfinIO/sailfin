...
Updated: 2026-08-22 (SFN-1040, SFN-1039, SFN-1026, SFN-808, SFN-1024). Seed pinned to `0.10.4` (`bootstrap.toml`
...
- **Toolchain version pinning — Phase 1** (SFEP-0046, SFN-167). `capsule.toml`
  ...
  **Phase 2 acquire — `sfn toolchain install <version>`** (SFEP-0046 §3.5,
  ...
  (SFEP-0071 §3.4/§3.6, SFN-898): `targz_extract` (`capsules/sfn/archive/src/
...
During the SFEP-0072 transition, dependency-free foundation capsules ship from
`stdlib/*` while the remaining standard-library capsules stay under
`capsules/sfn/*`. Their manifest identities and imports are unchanged (for
