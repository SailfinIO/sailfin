...
| `E10xx` | Lowering / backend (`E1001` unsafe import-symbol mangling, SFN-530; `E1002` fabricated default value for an expression that failed to lower, SFN-527; `E1003` dropped or unsupported instruction, SFN-528) | `llvm/` |
