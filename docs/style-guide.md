...
| `E05xx`–`E06xx` | Build / check tooling; parse diagnostics `E0500` (unrecognized top-level construct), `E0501` (malformed function parameter list), `E0502` (missing variable initializer), `E0503` (missing struct field type); capsule distribution (`E0612` capsule marked unpublishable, SFEP-0002 §3.7 / SFN-714; `E0613` private capsule resolved from a fetched origin, SFEP-0020 §3.6 / SFN-715) | `tools/check.sfn`, `cli/commands/publish.sfn`, `capsule_resolver/provenance.sfn` |
