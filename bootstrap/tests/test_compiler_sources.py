...
def test_compile_compiler_source(source_path: pathlib.Path) -> None:
    ...
    if source_path.name == "main.sfn":
        ...
        def compile_module(relative: str) -> None:
            ...
            module_compiled = compile(module_python, str((REPO_ROOT / relative).with_suffix(".py")), "exec")
        ...
        sailfin_output = compile_to_sailfin(source)
        ...
        assert native_result.module.artifacts
