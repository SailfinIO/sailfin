...
Expression = getattr(__module_1, 'Expression')
FieldDeclaration = getattr(__module_1, 'FieldDeclaration')
ForClause = getattr(__module_1, 'ForClause')
...
TypeAnnotation = getattr(__module_1, 'TypeAnnotation')
TypeParameter = getattr(__module_1, 'TypeParameter')
WithClause = getattr(__module_1, 'WithClause')
