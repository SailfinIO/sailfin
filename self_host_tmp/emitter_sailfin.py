...
def emit_program(program):
    ...
    builder = builder_emit_line(builder, 'import { sleep, channel, parallel, spawn, fs, serve, http, websocket, logExecution, array_map, array_filter, array_reduce } from \"sailfin/runtime\";')
    builder = builder_emit_blank(builder)
    index = 0
    while True:
